...
echo "	<h2><center>Feedbacks<center></h2>";
...
@mysql_select_db (DB_NAME) OR die ('Could not select the database: ' . mysql_error() );
 ...
 $query = "INSERT INTO feedback (name, message) VALUES ('$username', '$feedbackmessage')";	  
...
$retval = mysql_query( "SELECT * FROM feedback LIMIT 30 ", $dbc );
